...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "text-muted-foreground flex h-fit w-fit items-center justify-center rounded-lg",
        className
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:text-white/95 px-3 border-r-2 first:pl-0 last:border-r-0",
        className
      )}
      {...props}
    />
